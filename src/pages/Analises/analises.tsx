    ...
    return (
        ...
        <>
                ...
                <section className="responsividade">
                    ...
                    {/* <div className="respon_direito">
                        <div className="barra_respon">
                            <div className="menu_respon">
                                <img src="img/BOTÃO DO MENU.svg" alt="" />
                            </div>
                            <div className="perfil_respon">
                                <div className="select_respon">
                                    <input type="checkbox" id="check_respon" />
                                    <label htmlFor="check_respon">
                                        <img src="./img/down.svg" alt="" />
                                    </label>
                                    <nav>
                                        <ul>
                                            <li>
                                                <a href="#" className="tamanho_img">
                                                    <p>Sair</p>
                                                </a>
                                            </li>
                                        </ul>
                                ...
                                <div className="foto_respon">
                                    <img src="./img/Rectangle 60.png" alt="" />
                                </div>
                                <div className="planta_respon">
                                    <p>Panta de Taubaté </p>
                                </div>
                                <div className="navegacao_respon">
                                    <a href="#">
                            ...
                            <div className="configuracao_respon">
                                <a href="#">
                                    <img src="./img/botao-ligado.png" alt="" />
                                </a>
                                <a href="#">
